...
# Git clones
clone_if_missing "https://github.com/FaqatZubair1/Lineage_android_device_motorola_fogos.git" "luna" "device/motorola/fogos"
...
clone_if_missing "https://github.com/FaqatZubair/Lineage_android_vendor_motorola_fogos.git" "16.2" "vendor/motorola/fogos"
